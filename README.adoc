= TechNexion Yocto 5.3 Whinlatter 6.18.y GA BSP
...
[source,console]
$: repo init -u https://github.com/TechNexion/tn-imx-yocto-manifest.git -b whinlatter_6.18.y-next -m imx-6.18.2-1.0.0.xml
...
[source,console]
$: WIFI_FIRMWARE=y DISTRO=fsl-imx-xwayland MACHINE=edm-imx95 source tn-setup-release.sh -b build-xwayland-edm-imx95
