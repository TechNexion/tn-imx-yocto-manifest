...
For Container OS:
$: repo init -u https://github.com/TechNexion/tn-imx-yocto-manifest.git -b zeus_5.4.y-next -m imx-5.4.24-2.1.0-virtualization.xml
$: repo sync -j8
...
.Choosing TechNexion target container image
|===
|Image name |Target
