...
Ubuntu 22.04 Gnome base on Kirkstone 4.0
[source,console]
...
`<target-image>`:: is to choose the target image.
...
**NOTE**: +
**Only support 64bit platform**
|===

---
== Build Yocto/Ubuntu for TechNexion target platform
