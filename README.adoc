...
- *Yocto Xwayland image*
[source,console]
$: WIFI_FIRMWARE=y DISTRO=fsl-imx-xwayland MACHINE=edm-e-imx93 source tn-setup-release.sh -b build-xwayland-edm-e-imx93
$: bitbake imx-image-full

- *Ubuntu Gnome desktop*
[source,console]
$: WIFI_FIRMWARE=y DISTRO=imx-desktop-xwayland MACHINE=edm-e-imx93 source tn-setup-release.sh -b build-xwayland-edm-e-imx93
$: bitbake imx-image-desktop
