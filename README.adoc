...
[source,console]
$: repo init -u https://github.com/TechNexion/tn-imx-yocto-manifest.git -b zeus_5.4.y-stable -m imx-5.4.70-2.3.0_2021Q1.xml
...
'all' option will add both 'qca' and 'ath-pci' firmware package in yocto build.
