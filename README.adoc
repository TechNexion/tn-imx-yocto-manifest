= TechNexion Yocto 6.0 Wrynose 6.18.y GA BSP
...
[source,console]
$: repo init -u https://github.com/TechNexion/tn-imx-yocto-manifest.git -b wrynose_6.18.y-stable -m imx-6.18.20-2.0.0.xml
